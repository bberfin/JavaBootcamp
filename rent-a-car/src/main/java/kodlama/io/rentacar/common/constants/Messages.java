...
//içindeki methodlar herhangi bir varlıkla çalışmayacağı için statik method olarak tanımlayacağız
//static method bulunacağı için de class ı static tanımladık
